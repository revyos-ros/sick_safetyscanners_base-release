...
#ifndef SICK_SAFETYSCANNERS_BASE_DATASTRUCTURE_DATAGRAMHEADER_H
#define SICK_SAFETYSCANNERS_BASE_DATASTRUCTURE_DATAGRAMHEADER_H
...
#endif // SICK_SAFETYSCANNERS_BASE_DATASTRUCTURE_DATAGRAMHEADER_H
